...
public class TimerAspect {
    ...
    @Pointcut("@annotation(ru.gb.spring.aspect.Timer)")
    ...
    public Object aroundTimerMethods(ProceedingJoinPoint pjp) throws Throwable{
        ...
        try {
            ...
            log.info("Type {} , Method {} duration = {} ms", target.getClass().getName(),pjp.getSignature().getName(), duration);
        }
    }
}
