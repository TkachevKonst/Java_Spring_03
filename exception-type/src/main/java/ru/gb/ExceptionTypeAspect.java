...
public class ExceptionTypeAspect {
    ...
    private final ExceptionTypeProrerties exceptionTypeProrerties;

    public ExceptionTypeAspect(ExceptionTypeProrerties exceptionTypeProrerties) {
        this.exceptionTypeProrerties = exceptionTypeProrerties;
    }

    @Pointcut("@annotation(ru.gb.ExceptionType)")
    ...
    public Object afterThrowingTypeException(ProceedingJoinPoint pjp) throws Throwable {
        ...
        Object value = null;
        if (exceptionTypeProrerties.isEnabled()) {
